      ...
      <View style={styles.successContainer}>
        <View style={styles.successCard}>
          ...
          <Text style={styles.successMessage}>
            Your order from {vendor.name} has been confirmed and is being prepared.
          </Text>
          <CustomButton
            onPress={() =>
              navigation.reset({
  ...
  return (
    <View style={styles.flex}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <Text style={styles.headerSubtitle}>Review and complete your order</Text>
      </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            {cartItems.map((item: any, index: number) => (
              <View key={index} style={styles.orderItem}>
                ...
                <Text style={styles.itemTotal}>GH₵{item.price * item.quantity}</Text>
              </View>
            ))}
          </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.fieldGroup}>
              ...
              >
                <Text style={styles.networkText}>{NETWORKS[selectedNetwork]}</Text>
                <Ionicons
              ...
              {networkOpen && (
                <View style={styles.dropdown}>
                  {NETWORKS.map((n, i) => (
                    <TouchableOpacity
                      key={n}
                      style={[styles.dropdownItem, i === NETWORKS.length - 1 && styles.dropdownLast]}
                      onPress={() => {
                        setSelectedNetwork(i);
                        setNetworkOpen(false);
                      }}
                    >
                      <Text style={[styles.dropdownText, selectedNetwork === i && styles.dropdownActive]}>
                        {n}
                      </Text>
                    </TouchableOpacity>
                  ))}
      ...
      <View style={[styles.bottomBar, { paddingBottom: insets.bottom + 8 }]}>
        <CustomButton onPress={() => setOrderPlaced(true)} fullWidth>
          Complete Order • GH₵{total}
        </CustomButton>
      </View>
    </View>
  );
