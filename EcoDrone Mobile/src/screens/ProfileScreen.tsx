...
const menuItems: MenuItem[] = [
  { icon: 'person-outline', label: 'Personal Information', iconColor: colors.info, iconBg: colors.infoLight },
  { icon: 'location-outline', label: 'Saved Addresses', iconColor: colors.success, iconBg: colors.successLight },
  { icon: 'card-outline', label: 'Payment Methods', iconColor: '#7c3aed', iconBg: '#ede9fe' },
  { icon: 'notifications-outline', label: 'Notifications', iconColor: colors.warning, iconBg: colors.warningLight },
  { icon: 'help-circle-outline', label: 'Help & Support', iconColor: '#4338ca', iconBg: '#e0e7ff' },
];
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.userCard}>
          ...
          <View style={styles.userInfo}>
            ...
            <Text style={styles.userEmail}>john.doe@ashesi.edu.gh</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.contactCard}>
          ...
          <View style={styles.contactRow}>
            ...
            <Text style={styles.contactText}>john.doe@ashesi.edu.gh</Text>
          </View>
          <View style={styles.contactRow}>
