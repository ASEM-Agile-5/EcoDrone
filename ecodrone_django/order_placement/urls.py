...
from .views import MenuByVendorView, PlaceOrderView, OrderDetailsView, OrderView, OrderByStatusView, SetOrderStatusView, OrderByUserView, LocationListView, RegisterLocationView
