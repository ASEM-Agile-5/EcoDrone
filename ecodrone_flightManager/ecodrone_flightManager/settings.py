"""
Django settings for ecodrone_flightManager project.
...
SECRET_KEY = 'django-insecure-#ywr0v6@^)&19^rrb#&-el_gn!=j$8i5f-!@-^x*1k-ry#e+20'
...
ROOT_URLCONF = 'ecodrone_flightManager.urls'
...
WSGI_APPLICATION = 'ecodrone_flightManager.wsgi.application'
...
# Crontab settings
CRONJOBS = [
    ('*/1 * * * *', 'ecodrone_flightManager.cron.CheckOrders'),
]
